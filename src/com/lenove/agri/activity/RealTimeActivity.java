...
public class RealTimeActivity extends BaseActivity {
	...
	private void initView() {
		...
		airTemp = new MyChartView(this, "空气温度");
		airHumd = new MyChartView(this, "空气湿度");
		soidTemp = new MyChartView(this, "土壤温度");
		soidHumd = new MyChartView(this, "土壤湿度");
		light = new MyChartView(this, "光照强度");
		co2 = new MyChartView(this, "二氧化碳");
